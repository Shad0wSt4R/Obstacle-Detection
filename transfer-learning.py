...
train_generator=train_datagen.flow_from_directory('/home/marlena/Obstacle-Detection/training/',
                                                target_size=(224,224),
                                                color_mode='rgb',
                                                batch_size=32,
...
opt = Adam(lr=0.00001, beta_1=0.9, beta_2=0.999, epsilon=0.01, decay=0.01, amsgrad=False)
